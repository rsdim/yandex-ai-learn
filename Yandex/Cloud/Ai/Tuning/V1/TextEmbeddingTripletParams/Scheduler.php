...
/**
 * Generated from protobuf message <code>yandex.cloud.ai.tuning.v1.TextEmbeddingTripletParams.Scheduler</code>
 */
class Scheduler extends \Google\Protobuf\Internal\Message
{
    protected $type;
    protected $optional_warmup_ratio;
    ...
    public function hasWarmupRatio()
    {
     ...
     * @return string
     */
    public function getOptionalWarmupRatio()
    {
        return $this->whichOneof("optional_warmup_ratio");
    }

}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(Scheduler::class, \Yandex\Cloud\Ai\Tuning\V1\TextEmbeddingTripletParams_Scheduler::class);
