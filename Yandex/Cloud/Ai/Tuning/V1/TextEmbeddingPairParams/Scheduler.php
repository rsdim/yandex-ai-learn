...
/**
 * Generated from protobuf message <code>yandex.cloud.ai.tuning.v1.TextEmbeddingPairParams.Scheduler</code>
 */
...
class_alias(Scheduler::class, \Yandex\Cloud\Ai\Tuning\V1\TextEmbeddingPairParams_Scheduler::class);
