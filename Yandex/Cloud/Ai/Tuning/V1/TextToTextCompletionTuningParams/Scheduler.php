...
/**
 * Generated from protobuf message <code>yandex.cloud.ai.tuning.v1.TextToTextCompletionTuningParams.Scheduler</code>
 */
...
class_alias(Scheduler::class, \Yandex\Cloud\Ai\Tuning\V1\TextToTextCompletionTuningParams_Scheduler::class);
