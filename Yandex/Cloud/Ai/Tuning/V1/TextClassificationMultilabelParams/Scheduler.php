...
/**
 * Generated from protobuf message <code>yandex.cloud.ai.tuning.v1.TextClassificationMultilabelParams.Scheduler</code>
 */
...
class_alias(Scheduler::class, \Yandex\Cloud\Ai\Tuning\V1\TextClassificationMultilabelParams_Scheduler::class);
