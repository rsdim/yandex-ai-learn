...
/**
 * Generated from protobuf message <code>yandex.cloud.ai.dataset.v1.GetDownloadUrlsRequest</code>
 */
class GetDownloadUrlsRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * ID of the dataset.
     *
