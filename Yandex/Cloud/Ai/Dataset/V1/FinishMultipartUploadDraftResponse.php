...
/**
 * Generated from protobuf message <code>yandex.cloud.ai.dataset.v1.FinishMultipartUploadDraftResponse</code>
 */
class FinishMultipartUploadDraftResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * ID of the dataset.
     *
